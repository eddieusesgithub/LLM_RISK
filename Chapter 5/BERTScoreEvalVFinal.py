...
OUTPUT_CSV_FILENAME = 'BERTSCORE_sc.csv' # save to this file
...
def main():
    ...
    with open(INPUT_CSV_FILENAME, mode='r', newline='', encoding='utf-8') as infile:
            ...
            all_data.append(input_headers + ['BERTScore_F1']) # add new columns for each metric
